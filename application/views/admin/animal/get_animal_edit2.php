...
?>
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            แก้ไขชนิดสัตว์เลี้ยง <small></small>
                        </h1>
                    </div>
                </div>
                <!-- /.row -->
                <div class="container">
                <div class="row">
                <form action = "<?php echo $a.'index.php/Admin/Admin/postEditAnimal/'; ?>" class="form-horizontal" method = "post" id = "registration" name = "registration">
                       <input type="hidden" name="id_hide" id="id_hide" value="<?php echo $id; ?>">
                        <fieldset>
                        <!-- Form Name -->
                        <!-- <legend></legend> -->
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6">
                          <input id="animal_name" name = "animal_name" type="text" placeholder="ชนิดสัตว์เลี้ยง" class="form-control input-md" value = "<?php echo $data['animal_name']; ?>">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6">
                          <input id="animal_detail" name = "animal_detail" type="text" placeholder="อื่นๆ" class="form-control input-md" value = "<?php echo $data['animal_detail']; ?>">
