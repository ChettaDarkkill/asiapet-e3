                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            แก้ไขข่าวสารของคลินิก<small></small>
                        </h1>
                    </div>
                </div>
            </div>
     ...
     <!-- /.row -->
                <div class="container">
                <div class="row">
                    <form action = "<?php echo $a.'index.php/News/News/postNewsEdit/'; ?>" class="form-horizontal" method = "post" id = "registration" name = "registration">
                      <input id="id_hide" name = "id_hide" type="hidden" value = "<?php echo $data[0]['id']?>">
                        <fieldset>
                        <!-- Form Name -->
                        <!-- <legend></legend> -->
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6">
                          <input id="title" name = "title" type="text" placeholder="หัวข้อข่าว" class="form-control input-md" value = "<?php echo $data[0]['title']?>">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6">                     
                            <textarea class="form-control" id="details" name = "details" placeholder="รายละเอียดข่าว"><?php echo $data[0]['details']?></textarea>
                          </div>
                        </div>
