...
class reportReceive extends MXAdmin_Controller {
  ...
  public function goReport(){
        $data['data'] = $this->report_model->reportReceive();

        $html = $this->load->view('admin/report/data/report_receive', $data, true);
        $pdfFilePath = "รายงานสรุปรายรับของร้าน.pdf";
