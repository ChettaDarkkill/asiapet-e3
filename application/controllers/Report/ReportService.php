...
class ReportService extends MXAdmin_Controller {
  ...
  public function goReport(){
        $data['all_product'] = $this->report_model->reportService();
        $html = $this->load->view('admin/report/data/report_service', $data, true);
        $pdfFilePath = "รายงานการรักษาและใช้บริการ.pdf";
